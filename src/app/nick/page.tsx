...
import { FILM, NICK, PASSPORT_URL } from "@/lib/passport/nick";
...
const description = `${NICK.headline} Watch his story, see him at work, and hear from his team at Sarasota Ford.`;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: PASSPORT_URL,
    type: "profile",
    images: [{ url: FILM.poster, alt: FILM.posterAlt }],
  },
  twitter: { card: "summary_large_image", title, description, images: [FILM.poster] },
};
